...
const FooterComponent: FC = () => {
    ...
    return (
        <>
        <footer className="bg-[#eee] text-white py-10">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className='flex flex-col gap-3'>
                        <h4 className="font-bold text-lg text-black">Cita Rasa</h4>
                        <p className='text-black'>Solusi pengiriman dan resep makanan terbaik Anda.</p>
                    </div>
                    <div>
                        <h4 className="font-bold text-lg text-black">Kategori</h4>
                            <ul className='py-3 space-y-2'>
                                {linkKategory.map(({ name, path } : any, i: number) => (
                                    <li key={i}>
                                        <Link href={path} className='hover:underline text-black opacity-55'>{name}</Link>
                                    </li>
                                    ))
                                }
                        </ul>
                    ...
                    <div>
                        <h4 className="font-bold text-lg text-black">Tentang</h4>
                         <ul className='py-3 space-y-2'>
                    ...
                    <div className='flex flex-col gap-1'>
                        <h4 className="font-bold text-lg pb-3 text-black">Kontak Kami</h4>
                        <p className='text-black opacity-55'>info@citarasa.com</p>
                        <p className='text-black opacity-55'>+62 851-5694-8098</p>
        ...
        <div className="text-center w-full bg-white p-3 opacity-50">
